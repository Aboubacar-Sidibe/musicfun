...
;(function(window) {
	...
	Turntable.prototype._play = function(bufferOffset) {
		...
		// Set up the room effect and the right audio nodesÂ´ connections.
		this.setEffect();
	...
	Turntable.prototype.setEffect = function(idx) {
		...
		if( this.effect === -1 ) { // No effect.
			// readjust the nodesÂ´ connections.
			...
			// Set up the Convolver buffer and adjust the nodesÂ´ connections.
