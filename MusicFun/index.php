...
<html lang="en" class="no-js">
    <head>
        ...
        <link href="https://fonts.googleapis.com/css?family=Cardo|Squada+One&display=swap" rel="stylesheet">
    ...
    <body>
        <div class="container">
            <div class="w3-bar One">
                <a href="index.php" class="w3-bar-item w3-button">Home</a>
                <a href="discography.php" class="w3-bar-item w3-button">Discography</a>
                <a href="gallery.php" class="w3-bar-item w3-button">Gallery</a>
                <a href="tour.php" class="w3-bar-item w3-button">Tour</a>
            </div>
            <h4 class="w3-center cardo">WELCOME TO MOMO'S STUDIO, CLICK ON INSTRUMENTS TO PLAY YOUR CREATE MUSIC</h4>
                ...
                <div id="container-sequencer" class="container-sequencer collapse">
                    <div id="sequencer" class="sequencer">
                        ...
                        <div class="row" data-target-drum="kick">
                            <img src="img/kickmomo.png" alt="Kick">
                            <label><input type="checkbox"><span></span></label>
                            <label><input type="checkbox"><span></span></label>
                            <label><input type="checkbox"><span></span></label>
                            <label><input type="checkbox"><span></span></label>
