...
<html lang="en" class="no-js">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="css/style_disco.css" />
        ...
        <style>
            body #cdawrap {
                top: 15px;
                background: rgba(69, 189, 148, 0.53);
                border: none;
            }
        </style>
    ...
    <main>
        <div class="view view--grid view--current">
            <header class="page-header">
                <h1 class="page-header__title">Momo's Records</h1>
                <p class="page-header__subtitle">My classic record shop.Hope you enjoy😀😀😀😀 </p>               
            </header>
                ...
                <li class="grid__item">
                    <a class="grid__link" href="#album-1">
                        <div class="img-wrap img-wrap--grid">
                            ...
                            <img class="img img--grid" src="img/salifyemi.png" alt="album1" />
                        </div>
                        <span class="year">2000</span>
                        <h2 class="artist">Salif keita</h2>
                        <h3 class="title">Nous pas bouger</h3>
                    </a>
                </li>
        ...
        <div class="view view--single">
            ...
            <div class="single" id="album-1" data-side1="mp3/bouger.mp3,mp3/Dream_On_This_Side.mp3,mp3/Beautiful_Paranoia.mp3" data-side2="mp3/Dawn's_Battle.mp3">
                <div class="img-wrap img-wrap--single">
                    <img class="img img--single" src="img/salifyemi.png" alt="album1" />
                </div>
                <span class="number">01<span class="number__total">12</span></span>
                <h2 class="artist artist--single">Salif keita</h2>
                <h3 class="title title--single">Nous pas bouger</h3>
                <span class="year year--single">2000</span>
            </div>
